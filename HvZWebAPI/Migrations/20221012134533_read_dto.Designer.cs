...
namespace HvZWebAPI.Migrations
{
    ...
    [Migration("20221012134533_read_dto")]
    partial class read_dto
    {
            ...
            modelBuilder.Entity("HvZWebAPI.Models.Chat", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ChatTime = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7250),
                            GameId = 2,
                            IsHumanGlobal = false,
                            IsZombieGlobal = true,
                            Message = "Got him!",
                        ...
                        {
                            Id = 2,
                            ChatTime = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7252),
                            GameId = 2,
                            IsHumanGlobal = true,
                        ...
                        {
                            Id = 3,
                            ChatTime = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7254),
                            GameId = 2,
                            IsHumanGlobal = false,
                            IsZombieGlobal = false,
                            Message = "Like... Hello",
            ...
            modelBuilder.Entity("HvZWebAPI.Models.Kill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7231)
                        },
                        new
                        {
                            Id = 2,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7233)
                        },
                        new
                        {
                            Id = 3,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7234)
                        },
                        new
                        {
                            Id = 4,
                            GameId = 3,
                            TimeDeath = new DateTime(2022, 10, 12, 13, 45, 33, 362, DateTimeKind.Utc).AddTicks(7235)
                        });
                });

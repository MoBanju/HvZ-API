...
namespace HvZWebAPI.Migrations
{
    ...
    [Migration("20221013063656_seed_more_players")]
    partial class seed_more_players
    {
            ...
            modelBuilder.Entity("HvZWebAPI.Models.Chat", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ChatTime = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1398),
                            GameId = 2,
                            IsHumanGlobal = false,
                            IsZombieGlobal = true,
                            Message = "Got him!",
                        ...
                        {
                            Id = 2,
                            ChatTime = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1407),
                            GameId = 2,
                            IsHumanGlobal = true,
                        ...
                        {
                            Id = 3,
                            ChatTime = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1410),
                            GameId = 2,
                            IsHumanGlobal = false,
                            IsZombieGlobal = false,
                            Message = "Like... Hello",
            ...
            modelBuilder.Entity("HvZWebAPI.Models.Kill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1344)
                        },
                        new
                        {
                            Id = 2,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1353)
                        },
                        new
                        {
                            Id = 3,
                            GameId = 2,
                            TimeDeath = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1355)
                        },
                        new
                        {
                            Id = 4,
                            GameId = 3,
                            TimeDeath = new DateTime(2022, 10, 13, 6, 36, 55, 275, DateTimeKind.Utc).AddTicks(1357)
                        });
                });
